...
const Requests = {
  ...
  fetchHorrorMovies: `/discover/movie?api_key=${API_KEY}&with_genre=35`,
  fetchRomanceMovies: `/discover/movie?api_key=${API_KEY}&with_genre=35`,
  fetchDocumentaries: `/discover/movie?api_key=${API_KEY}&with_genre=35`,
};
